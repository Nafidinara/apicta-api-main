...
<head>
    ...
    <title>MyoScope</title>
    <meta name="description" content="Myocardial Infarction Detection">
...
<script>
    ...
    const primaryColor = localStorage.getItem('vuexy-initial-loader-color') || '#293077'
